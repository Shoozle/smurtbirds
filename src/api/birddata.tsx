const birddata = [
    {
        ...
        name: `Barn Swallow`,
        summary: `Or Swallow as it's just called in the UK. Prongs on the tail helps it stand out from other swallows. Arrives in April then leaves around October. Fast flyers but thankfully unlike Sand Martins they do like to rest now and then which makes for easier photographing. Juvenile Barn Swallows are cute!`,
        imageCount: 5,
        date: `18/04/2026`,
        location: `Holyhead`,
        whatStatus: `updated`,
